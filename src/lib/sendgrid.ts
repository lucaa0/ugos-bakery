...
// WARNING: Using the SendGrid API key on the client-side is a security risk.
// This is for demonstration purposes only and should not be used in a production environment.
// Consider using a backend server to handle email sending.
...
export const sendOrderEmails = async (orderData: OrderData, customerEmail: string, apiKey: string) => {
